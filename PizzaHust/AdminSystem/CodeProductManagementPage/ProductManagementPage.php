<?php
	$id = $msg = $title = $price  = $statusID = $categoryID = $date = $image = $description=$name='';
	...
	$id = getGet('id');
   	...
   	if($id != '' && $id > 0) {
		...
		if(getArrResult($sql) != null) {
			$categoryID = getArrResult($sql)['categoryID'];
			$price = getArrResult($sql)['price'];
			$title = getArrResult($sql)['title'];
			$statusID = getArrResult($sql)['statusID'];
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="left_div">
                            ...
                            <div class="form_group" style="top: 20%">
                                ...
                                <select class="form-control" name="categoryID" id="categoryID" required="true">
