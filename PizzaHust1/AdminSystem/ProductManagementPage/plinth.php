                            ...
                            <?php $index = 0; if(!empty($data)): foreach($data as $row): ?>
                                <tr id="<?php echo $row['id']; ?>">
                                    ...
                                    <td>
                                        ...
                                        <input class="editInput name_input form-control input-sm" type="text" name="name" value="<?php echo $row['name']; ?>" style="display: none; font-size: 15px">
                                    </td>
                                    <td>
                                        <span class="editSpan price_span"><?php echo $row['price']; ?></span>
                                        <input class="editInput price_input form-control input-sm" type="text" name="price" value="<?php echo $row['price']; ?>" style="display: none; font-size: 15px">
                                    </td>
                                    <td style="z-index: 4;">
